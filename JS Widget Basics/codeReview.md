...
- Hopefully this guide was a bit helpful for understanding how I coded. Most of this seems like rambling from a quick glance but words are the easiest way for me explain since there are some nuances that can't quite be explained simply by looking at the raw code. I wish I had more expertise to go further into the project

**_Code needs to be written for dynamically creating the HTML parts of the Canvas and making sure it follows the CSS grid property._**
